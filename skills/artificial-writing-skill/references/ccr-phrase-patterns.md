...
| [ccr-2026-09-19-supplement-language.md](ccr-2026-09-19-supplement-language.md) | Fourteen-paper addition spanning KRAS G12V/Q61 and STK11 context, MET biomarkers and targeted therapy, ctDNA, spatial and single-cell immunity, cellular therapy, phase I/II efficacy and safety, RET retreatment, mitotic cell death, and ADC pharmacology | Abstract; Introduction; Methods; Results; Discussion; Conclusion; Translational Relevance |
| [ccr-2026-09-19-batch2-language.md](ccr-2026-09-19-batch2-language.md) | Eight-paper second addition: STK11-priority AmpRatio genomics; plasmaCHORD and fragmentomics; longitudinal ctDNA; brain-metastasis immunotherapy; phase I immunocytokine/bispecific efficacy, safety, and pharmacology; single-nucleus RNA; macrophage preclinical experiments | Abstract; Introduction; Methods; Results; Discussion; Conclusion; Translational Relevance |

| [ccr-2026-09-19-pending15-language.md](ccr-2026-09-19-pending15-language.md) | Fifteen previously indexed 2026 papers: diagnostic methylation, allele-specific genomics, PFAS epidemiology, targeted/ADC therapy, resistance, patient-reported outcomes, adaptive radiotherapy, RRAS functional models, PEF immune profiling and AI pathology | Abstract; Introduction; Methods; Results; Discussion; Conclusion; Translational Relevance |
...
The four-paper September 12 addition is indexed section by section in [ccr-2026-09-12-supplement-language.md](ccr-2026-09-12-supplement-language.md): NRF2/STK11/KEAP1 experimental and clinical language; LAURA subsequent-treatment and immature-survival reporting; ATR/PD-L1 combination, bulk bioinformatics, and Bayesian estimates; and YL201 targeted plasma proteomics with exploratory biomarker calibration. The three-paper September 14 priority set is indexed in [ccr-2026-09-14-atm-smarca4-stk11-priority-language.md](ccr-2026-09-14-atm-smarca4-stk11-priority-language.md): SMARCA4/ATM/STK11 co-mutation language, variant-to-protein interpretation, prognostic and treatment-associated survival reporting, bulk-RNA immune deconvolution, RPPA terminology, and ATM-knockout chemotherapy experiments. The fourteen-paper September 19 addition is indexed in [ccr-2026-09-19-supplement-language.md](ccr-2026-09-19-supplement-language.md), with two new STK11-priority KRAS allele frameworks and section-specific clinical, multi-omic, biomarker, statistical, experimental, and therapeutic language. The eight-paper second September 19 addition is indexed in [ccr-2026-09-19-batch2-language.md](ccr-2026-09-19-batch2-language.md), with AmpRatio as an STK11-priority framework and article-specific evidence/page maps, numerical checks, and claim boundaries. The later 15-paper existing-index completion is in [ccr-2026-09-19-pending15-language.md](ccr-2026-09-19-pending15-language.md), with one-article page locators, separated vocabulary and synthetic frames, Results/Discussion paragraph models, and explicit source-conflict restrictions. Each new expression has a single-paper scope. These additions do not expand the source scope of the historical 39-paper Title/Abstract synthesis.
