...
- Source PDFs indexed: **239**, including eight newly verified main PDFs (113 pages). The prior recorded corpus page total was3,957; adding this batch gives4,070 recorded physical pages. Historical source-coverage flags are retained, not newly re-audited for every old article. PDF parsing or corpus processing is not equivalent to language-focused deep reading or supplement review.
...
- The latest 2025 intake adds **eight original articles**, **113 main-PDF pages** and **83,022 raw extraction tokens**. Main text and all main figures/tables were read; separate supplements were not supplied. See [article evidence and language](ccr-2025-2026-09-19-intake-language.md) and [version/hash manifest](ccr-2025-2026-09-19-intake-manifest.csv). Three identical Cancer Discovery/Nature priority PDFs retain prior reading records. One medRxiv v1 is recorded separately and does not complete its formal CCR counterpart PMID40272273.
- Across the recorded CCR batches, **91 articles** have completed initial main-article language-focused reading, with **1,828 recorded physical pages** and **963,887 raw extracted tokens**. These historical-plus-current extraction totals include administrative material, references and graph labels, not standardized body words. Acceptance source recheck remains separate. The legacy body corpus and phrase-example bank were not recomputed.
...
- Completed: **91 articles**. The previous83 records retain their original dates and evidence; eight newly supplied2025 main articles are added on2026-09-19. Check [library-index.md](library-index.md) for generated journal/year totals and [the quality register](ccr-reading-quality-register.csv) for acceptance status.
...
[ccr-section-language-catalog.csv](ccr-section-language-catalog.csv) currently represents **91 CCR main-text-read articles** with **2,996 entries**. The latest eight-paper2025 intake adds226 single-paper items:98 vocabulary/collocations,112 synthetic sentence frames and16 synthetic paragraph models. Source conflicts and PDF-page locators remain in the article assets. Entry counts measure inventory size, not scientific reading quality.

Current unit totals:1,661 vocabulary/collocations,1,187 sentence frames,20 phrase frames,28 paragraph architectures,7 sentence models and93 paragraph models. Primary sections:12 Title,329 Abstract components,493 Introduction,895 Methods,738 Results,405 Discussion,65 Conclusion and59 Translational Relevance. Provenance granularity:2,069 single-paper,518 subsection and409 batch/cross-corpus syntheses. The preprint language is outside this CCR catalog.

Regenerate the catalog after language changes, then rebuild [library-index.md](library-index.md) with `scripts/build_library_index.py`. Do not treat the catalog as the historical9,411-row statistical phrase-example bank or as evidence of verbatim source wording.
